...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="card" style="h-100;">
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <p class="card-title d-flex justify-content-evenly">
      <span><i class="fas fa-star mx-1 text-warning"></i>${product.rating.rate}</span>
      <span><i class="fas fa-user mx-1 text-secondary"></i>${product.rating.count}</span>
    </p>
